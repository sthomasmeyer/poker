...
class CreateAccountForm(FlaskForm):
    ...
    password = PasswordField(
        ...
        validators=[
            ...
            Regexp(".*[a-z].*", message="Your password must contain at least one lower-case character."),
            Regexp(".*[A-Z].*", message="Your password must contain at least one upper-case character."),
            Regexp(".*\d.*", message="Your password must contain at least one number (0-9).")
        ])
